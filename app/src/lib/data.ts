// Static demo data for serverless deployment (no database needed)
...
export const BARS = [
  {
    ...
    certifications: ["Extincteurs", "Issues secours"],
    details: [
  ...
  },
  {
    ...
    certifications: ["Extincteurs", "Issues secours", "Détecteurs"],
    details: [
      { label: "Extincteurs", value: "Conformes", status: "green" },
      { label: "Issues secours", value: "Conformes", status: "green" },
  ...
  },
  {
    ...
    certifications: ["Extincteurs", "Issues secours", "Éclairage"],
    details: [
      { label: "Extincteurs", value: "Conformes", status: "green" },
      { label: "Issues secours", value: "Conformes", status: "green" },
      { label: "Détecteurs fumée", value: "Conformes", status: "green" },
...
export const PARTNERS = [
  {
    ...
    logo: "shield",
    logoColor: "#1A1A3A",
    badges: [{ cls: "pb-agree", label: "Partenaire officiel" }, { cls: "pb-local", label: "30 000 gérants" }, { cls: "pb-certif", label: "CHR France" }],
    tags: ["fédération", "erp"],
    rating: 4.9,
    reviews: 312,
  ...
  },
  {
    ...
    logo: "building",
    logoColor: "#1A3A6A",
    badges: [{ cls: "pb-agree", label: "Agréé Préfecture" }, { cls: "pb-local", label: "Tours" }, { cls: "pb-certif", label: "ERP certifié" }],
    tags: ["bureau", "erp"],
    rating: 4.8,
    reviews: 124,
    delay: "Sous 5 jours",
  ...
  },
  {
    ...
    logo: "check",
    logoColor: "#1A2A3A",
    badges: [{ cls: "pb-agree", label: "Agréé Préfecture" }, { cls: "pb-certif", label: "ERP certifié" }],
